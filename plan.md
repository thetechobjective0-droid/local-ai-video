...
The latest CI formatting regression is being normalized against Ruff 0.16.7 before the next full CI validation; no formatter auto-commit is used in CI. Evaluation, production-gate, FFmpeg, and security formatting have now been normalized.
